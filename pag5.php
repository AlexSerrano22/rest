		...
		<script type="text/javascript">
			...
			<nav id="bt-menu" class="bt-menu">
				...
				<ul>
					...
					<li><a href="pag2.php<?php echo '?ido='.$_GET['ido']; ?>">Mas fuerte</a></li>
					<li><a href="pag3.php<?php echo '?ido='.$_GET['ido']; ?>">Entradas</a></li>
					<li><a href="pag4.php<?php echo '?ido='.$_GET['ido']; ?>">Carnes</a></li>
					<li><a href="pag5.php<?php echo '?ido='.$_GET['ido']; ?>">Jugos</a></li>
				</ul>
				<ul>
