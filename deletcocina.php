					...
					<div class="rm-wrapper">
						...
						<div class="rm-middle">
								...
								$result = mysqli_query($con,"SELECT * FROM imprimir WHERE IdOrden ='$_GET[ido]'");
								 ...
								 $i=0;
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a class='elimina' href='#' onclick='eliminaC($i)' >$row[alimentos]</a></dt><dd>$row[cant] <input type='hidden' value='$row[alimentos]' id='$i'></dd>";
										$i++;
										}
							...
							?>
								...
								<button onclick="window.location='delet.php<?php echo '?ido='.$_GET['ido']; ?>'">Eliminar de Cuenta</button>
									</div>
								</div><!-- /rm-content -->
