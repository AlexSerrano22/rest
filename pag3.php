				...
				<div id="rm-container" class="rm-container">
					...
					<div class="rm-wrapper">
						...
						<div class="rm-cover">
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='7'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='7'");
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='8'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='8'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
						...
						<div class="rm-middle">
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='9'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='9'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='10'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='10'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='13'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='13'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
						...
						<div class="rm-right">
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='11'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='11'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
							...
							<?php
								$result = mysqli_query($con,"SELECT * FROM alimento WHERE IdSub ='12'");
								$sub= mysqli_query($con,"SELECT * FROM submenu WHERE idSub='12'");
								$rsub =  mysqli_fetch_array($sub);
								 $salida="<h4>$rsub[Descripcion]</h4><dl>";
									while($row = mysqli_fetch_array($result)){
										$salida.="<dt><a href='#' class='rm-viewdetails' data-thumb='images/11.jpg' >".nl2br(htmlentities($row['Nombre']))."</a></dt><dd><input type='hidden' value='$row[idAlimento]' id='".nl2br(htmlentities($row['Nombre']))."'></dd>";
